...
namespace Test\third_iteration\anonymous_classes;

use PHPUnit_Framework_TestCase;
use third_iteration\anonymous_classes\Gesture;
use third_iteration\anonymous_classes\RockPaperScissorsSolver;
